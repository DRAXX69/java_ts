...
//iteation using callback
const howTolerate = (item,index,arr)=>{
    //logic to iterate
    console.log(index,item);
}
fruits.forEach(howTolerate);
...
const students = [
    {name: "Kritan", age: 22, grade: 80},
    {name: "Ram", age: 25, grade: 90},
...
const evenIndexStudents = students.filter((student, index) => index % 2 === 0);
